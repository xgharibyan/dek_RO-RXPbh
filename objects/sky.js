...
export class Sky {
    constructor() {
        let skyUniforms = THREE.UniformsUtils.clone(skyShader.uniforms);
        ...
        let skyGeo = new THREE.SphereBufferGeometry(4500, 32, 15);
...
export class SkyObject extends THREEObject {
    constructor () {
...
export const sky = new SkyObject();
